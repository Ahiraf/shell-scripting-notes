...
## 🔹 Types of Variables
### 🖥️ System Variables
Predefined by the system. Usually written in UPPERCASE.
Examples:
```
echo $HOME
echo $PWD
...
Created by the user. Can be lowercase or uppercase
```
name="Fariha"
echo $name
```
...
While running the script:  ./02_variables_&_comments.sh , I encountered the following error:
```
...
**In shell scripting:** & is a special operator. It tells the shell to run a command in the background
